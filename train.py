...
X_train = a + ( ((X_train - xminimum) * (b - a)) / range_of_x )
X_test = a + ( ((X_test - xminimum) * (b - a)) / range_of_x )
...
layer1 = Layer_Dense(784, 1000, weight_regulizer_l2=5e-4, bias_regulizer_l2=5e-4)
relu1 = Activation_ReLU()
layer2 = Layer_Dense(1000, 1000, weight_regulizer_l2=5e-4, bias_regulizer_l2=5e-4)
relu2 = Activation_ReLU()
layer3 = Layer_Dense(1000, 10, weight_regulizer_l2=5e-4, bias_regulizer_l2=5e-4)
...
plt.savefig("MNIST_from_Scratch.png")
plt.close()
